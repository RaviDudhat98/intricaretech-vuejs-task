...
<template>
  <div class="campaign-page">
    ...
    <AdvanceCampaignSetup v-else-if="currentView === 'advance'" @goBack="currentView = 'empty'"
      @submit="handleLaunch" />

    <StandardCampaignSetup v-else-if="currentView === 'standard'" @goBack="currentView = 'empty'"
      @submit="handleLaunch" />
